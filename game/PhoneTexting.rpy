...
screen nvl_phonetext(dialogue):
    ...
    for id_d, d in enumerate(dialogue):
        if d.who == None: # Narrator
            ...
            if d.who == MC_Name:
                $ message_frame = "extra/phone_send_frame.png"
            else:
                $ message_frame = "extra/phone_received_frame.png"
            ...
            hbox:
                ...
                if previous_d_who != d.who:
                    if d.who == MC_Name:
                        $ message_icon = "extra/phone_send_icon.png"
                    else:
                        $ message_icon = "extra/phone_received_icon.png"
