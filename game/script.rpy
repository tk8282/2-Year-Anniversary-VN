...
init python:
    credits = ('Mods',' ', 'Arin @light_arin'),('Mods',' ', 'Eve @Ebaelynn'),('Mods',' ', 'Aly @_Alycarus'),('Mods',' ', 'Angie @_kaokaos'),('Mods',' ', 'Ann @ann_teasocial'),('Mods',' ', 'TK @TkFlash2'),('Gale Route', 'Writers', 'Shelby @shoobilled'), ('Gale Route', 'Writers', 'Chia @chiaseed_lol'), ('Gale Route', 'Sprite', 'Zoo @Mawfische'),('Gale Route', 'CG', 'Cas @casterseer'),('Gale Route', 'Backgrounds', 'Jae @chromaticdawn') ,('Cass Route', 'Writers', 'Lala @oopsiesloops'), ('Cass Route', 'Writers', 'Sel @moiselvie'), ('Cass Route', 'Sprite', 'Jeanne @smolmouche'),('Cass Route', 'CG', 'Lafiska @Lafa_or_Life'),('Cass Route', 'Backgrounds', 'Karasu @karasu_draws'),('Luci Route', 'Writers', 'Lykos @Moonlit_Lykos'), ('Luci Route', 'Writers', 'Focks @starfocks_'), ('Luci Route', 'Writers', 'Anon'), ('Luci Route', 'Sprite', 'Ann @ann_teasocial'),('Luci Route', 'CG', 'Ken @kenwnyan'),('Luci Route', 'Backgrounds', 'Angie @_kaokaos'),('Zanny Route', 'Writers', 'Samatokiiis @samatokiiis'), ('Zanny Route', 'Writers', 'Axel @CheesyGabite'), ('Zanny Route', 'Sprite', 'Moka @mocha2ru'),('Zanny Route', 'CG', 'Miky San @MikySan29'),('Zanny Route', 'Backgrounds', 'Rain @rain__ghost'),('Rosco Route', 'Writers', 'Arin @light_arin '), ('Rosco Route', 'Writers', 'Bayqus @bayquswrites'), ('Rosco Route', 'Sprite', 'Chowwy @DogChow101'),('Rosco Route', 'CG', 'Hoshka @lohoshka'),('Rosco Route', 'Backgrounds', 'Cris @crisosstomo_'),('General', 'Homescreen', 'Zivvi @zivvikal'),('General', 'UI/UX', 'Candy @_amurta'),('General', 'Coding', 'TK @TkFlash2'),('General', 'Coding', 'Hanxi @Hanxiowo'),('General', 'Editing', 'Hannah B. @Beenana0_0'), ('General', 'Editing', 'Nyx @chamanthus '),('General', 'Editing', 'Eve @Ebaelynn '),('General', 'Music', 'Yena @sheepshxt'),('General', 'Music', 'Han Hyo Mi @Han_Hyomi_'),('General', 'Assets', 'Aly @_Alycarus'),('General', 'Assets', 'Zomboba  @Zomboba / @zomboblab'),('General', 'Assets', 'Destinie @Dezk_is_crying '),('General', 'Assets', 'Anon'),('General', 'Backgrounds', 'Ikin @akiramonsta'),('General', 'Backgrounds', 'Aly @_Alycarus'),
